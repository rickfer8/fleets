...
INSERT INTO usuario (id, nome, cpf, data_nascimento, email, senha, ativo, id_perfil)
  SELECT 1, 'Thiago Aguiar', '97223011521', '1985-01-29','thiagoferreiradeaguiar@gmail.com', '$2a$10$l9A8PP1Kexnn2Ull7Qht.u/LCxX1v83MvWrVA8cQygyxKstOtcIna', true, 1
    WHERE NOT EXISTS (SELECT 1 FROM usuario WHERE id = 1 AND cpf = '97223011521');
   
INSERT INTO usuario (id, nome, cpf, data_nascimento, email, senha, ativo, id_perfil)
  SELECT 2, 'Ricardo Ribeiro', '70549889060', '1987-02-03','ricardo.ferib@gmail.com', '$2a$10$l9A8PP1Kexnn2Ull7Qht.u/LCxX1v83MvWrVA8cQygyxKstOtcIna', true, 1
